...
const uint32_t MSIRangeTable[16] = {
    48000000U, 24000000U, 16000000U, 12000000U, 4000000U, 2000000U, 1500000U, 1000000U,
    3072000U,  1536000U,  1024000U,  768000U,   400000U,  200000U,  150000U,  100000U
};
/**
 * @}
 */
    ...
    switch (RCC->CFGR1 & RCC_CFGR1_SWS) {
        ...
        case 0x0C: /* PLL used as system clock source */
            ...
            */
            ...
            pllvco = pllvco * ((float_t) (uint32_t) (RCC->PLL1DIVR & RCC_PLL1DIVR_PLL1N) + (fracn1 / (float_t) 0x2000) +
                               (float_t) 1U);
