...
#define HAL_OSPI_WRAP_16_BYTES \
    ((uint32_t) OCTOSPI_DCR2_WRAPSIZE_1) /*!< external memory supports wrap size of 16 bytes  */
#define HAL_OSPI_WRAP_32_BYTES             \
    ((uint32_t) (OCTOSPI_DCR2_WRAPSIZE_0 | \
                 OCTOSPI_DCR2_WRAPSIZE_1)) /*!< external memory supports wrap size of 32 bytes  */
#define HAL_OSPI_WRAP_64_BYTES \
    ((uint32_t) OCTOSPI_DCR2_WRAPSIZE_2) /*!< external memory supports wrap size of 64 bytes  */
#define HAL_OSPI_WRAP_128_BYTES            \
    ((uint32_t) (OCTOSPI_DCR2_WRAPSIZE_0 | \
                 OCTOSPI_DCR2_WRAPSIZE_2)) /*!< external memory supports wrap size of 128 bytes */
/**
 * @}
 */
...
#define HAL_OSPI_OPTYPE_COMMON_CFG                                                                                   \
    ((uint32_t) 0x00000000U)                               /*!< Common configuration (indirect or auto-polling mode) \
                                                            */
...
#define HAL_OSPI_ALTERNATE_BYTES_DTR_DISABLE \
    ((uint32_t) 0x00000000U) /*!< DTR mode disabled for alternate bytes phase */
...
#define IS_OSPI_WRAP_SIZE(SIZE)                                                       \
    (((SIZE) == HAL_OSPI_WRAP_NOT_SUPPORTED) || ((SIZE) == HAL_OSPI_WRAP_16_BYTES) || \
     ((SIZE) == HAL_OSPI_WRAP_32_BYTES) || ((SIZE) == HAL_OSPI_WRAP_64_BYTES) || ((SIZE) == HAL_OSPI_WRAP_128_BYTES))
...
#define IS_OSPI_OPERATION_TYPE(TYPE)                                                   \
    (((TYPE) == HAL_OSPI_OPTYPE_COMMON_CFG) || ((TYPE) == HAL_OSPI_OPTYPE_READ_CFG) || \
     ((TYPE) == HAL_OSPI_OPTYPE_WRITE_CFG) || ((TYPE) == HAL_OSPI_OPTYPE_WRAP_CFG))
...
#define IS_OSPIM_IO_PORT(PORT)                                                                                         \
    (((PORT) == HAL_OSPIM_IOPORT_NONE) || ((PORT) == HAL_OSPIM_IOPORT_1_LOW) || ((PORT) == HAL_OSPIM_IOPORT_1_HIGH) || \
     ...
     ((PORT) == HAL_OSPIM_IOPORT_3_LOW) || ((PORT) == HAL_OSPIM_IOPORT_3_HIGH) ||                                      \
     ((PORT) == HAL_OSPIM_IOPORT_4_LOW) || ((PORT) == HAL_OSPIM_IOPORT_4_HIGH) ||                                      \
     ((PORT) == HAL_OSPIM_IOPORT_5_LOW) || ((PORT) == HAL_OSPIM_IOPORT_5_HIGH) ||                                      \
     ((PORT) == HAL_OSPIM_IOPORT_6_LOW) || ((PORT) == HAL_OSPIM_IOPORT_6_HIGH) ||                                      \
     ((PORT) == HAL_OSPIM_IOPORT_7_LOW) || ((PORT) == HAL_OSPIM_IOPORT_7_HIGH) ||                                      \
     ((PORT) == HAL_OSPIM_IOPORT_8_LOW) || ((PORT) == HAL_OSPIM_IOPORT_8_HIGH))
