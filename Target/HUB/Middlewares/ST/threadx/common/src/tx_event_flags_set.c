...
UINT _tx_event_flags_set(TX_EVENT_FLAGS_GROUP *group_ptr, ULONG flags_to_set, UINT set_option) {
    ...
    TX_TRACE_IN_LINE_INSERT(TX_TRACE_EVENT_FLAGS_SET, group_ptr, flags_to_set, set_option,
                            group_ptr->tx_event_flags_group_suspended_count, TX_TRACE_EVENT_FLAGS_EVENTS)
    ...
    if ((set_option & TX_EVENT_FLAGS_AND_MASK) == TX_AND) {
        ...
        if (interrupted_set_request == TX_TRUE) {
            ...
            /* Previous set operation was not interrupted, simply clear the
               ...
               of the group.  */
            group_ptr->tx_event_flags_group_current = group_ptr->tx_event_flags_group_current & flags_to_set;
