...
UINT _tx_semaphore_ceiling_put(TX_SEMAPHORE *semaphore_ptr, ULONG ceiling) {
    ...
    TX_TRACE_IN_LINE_INSERT(TX_TRACE_SEMAPHORE_CEILING_PUT, semaphore_ptr, semaphore_ptr->tx_semaphore_count,
                            semaphore_ptr->tx_semaphore_suspended_count, ceiling, TX_TRACE_SEMAPHORE_EVENTS)
