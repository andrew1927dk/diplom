                ...
                if (stack_highest != TX_NULL) {
                    ...
                    if (thread_ptr->tx_thread_id == TX_THREAD_ID) {
                        ...
                        if (stack_ptr > (TX_VOID_TO_ULONG_POINTER_CONVERT(thread_ptr->tx_thread_stack_start))) {
                            ...
                            /* Yes, now check that the new highest stack pointer is less than the previous highest stack
                             * pointer.  */
                            if (stack_ptr <
                                (TX_VOID_TO_ULONG_POINTER_CONVERT(thread_ptr->tx_thread_stack_highest_ptr))) {
