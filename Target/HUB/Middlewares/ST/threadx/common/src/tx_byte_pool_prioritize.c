...
UINT _tx_byte_pool_prioritize(TX_BYTE_POOL *pool_ptr) {
    ...
    TX_TRACE_IN_LINE_INSERT(TX_TRACE_BYTE_POOL_PRIORITIZE, pool_ptr, pool_ptr->tx_byte_pool_suspended_count,
                            TX_POINTER_TO_ULONG_CONVERT(&suspended_count), 0, TX_TRACE_BYTE_POOL_EVENTS)
