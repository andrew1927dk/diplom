...
UINT _tx_thread_resume(TX_THREAD *thread_ptr) {
    ...
    TX_TRACE_IN_LINE_INSERT(TX_TRACE_THREAD_RESUME_API, thread_ptr, thread_ptr->tx_thread_state,
    ...
    if (thread_ptr->tx_thread_state == TX_SUSPENDED) {
        ...
        TX_TRACE_IN_LINE_INSERT(TX_TRACE_THREAD_RESUME, thread_ptr, thread_ptr->tx_thread_state,
            ...
            if (priority < _tx_thread_highest_priority) {
                ...
                if (execute_ptr == TX_NULL) {
                    ...
                    if (priority < execute_ptr->tx_thread_preempt_threshold) {
                        ...
                        if (_tx_thread_performance_execute_log[_tx_thread_performance__execute_log_index] !=
                        ...
                        /* Now determine if preemption should take place. This is only possible if the current thread
                           pointer is not the same as the execute thread pointer AND the system state and preempt
