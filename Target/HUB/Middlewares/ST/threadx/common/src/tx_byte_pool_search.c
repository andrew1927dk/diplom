...
UCHAR *_tx_byte_pool_search(TX_BYTE_POOL *pool_ptr, ULONG memory_size) {
    ...
    total_theoretical_available = pool_ptr->tx_byte_pool_available +
                                  ((pool_ptr->tx_byte_pool_fragments - 2) * ((sizeof(UCHAR *)) + (sizeof(ALIGN_TYPE))));
    if (memory_size >= total_theoretical_available) {
        ...
        if (available_bytes != ((ULONG) 0)) {
            ...
            if ((available_bytes - memory_size) >= ((ULONG) TX_BYTE_BLOCK_MIN)) {
                ...
                /* Split the block.  */
                next_ptr =
                    TX_UCHAR_POINTER_ADD(current_ptr, (memory_size + ((sizeof(UCHAR *)) + (sizeof(ALIGN_TYPE)))));
            ...
            *this_block_link_ptr = TX_BYTE_POOL_TO_UCHAR_POINTER_CONVERT(pool_ptr);
            ...
            pool_ptr->tx_byte_pool_available =
                (pool_ptr->tx_byte_pool_available - available_bytes) - ((sizeof(UCHAR *)) + (sizeof(ALIGN_TYPE)));
