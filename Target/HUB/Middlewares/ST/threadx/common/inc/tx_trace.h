...
/* Trace Buffer Entry. The Trace Buffer Entry contains information about a particular
   event in the system. The high-level format of the Trace Buffer Entry is:
            ...
            [Thread Priority or         4           This 4-byte field contains the current thread pointer for interrupt
             Current Thread                         events or the thread preemption-threshold/priority for thread
   events. Preemption-Threshold/ Priority] [Event ID]                  4           This 4-byte field contains the Event
   ID of the event. A value of 0xFFFFFFFF indicates the event is invalid. All events are marked as invalid during
   initialization. [Time Stamp]                4           This 4-byte field contains the time stamp of the event.
...
#define TX_TRACE_BLOCK_POOL_PERFORMANCE_INFO_GET \
    14 /* I1 = pool ptr                                                            */
#define TX_TRACE_BLOCK_POOL__PERFORMANCE_SYSTEM_INFO_GET \
    15                                    /* None                                                                     */
...
#define TX_TRACE_BYTE_POOL_PERFORMANCE_INFO_GET \
    24 /* I1 = pool ptr                                                            */
#define TX_TRACE_BYTE_POOL__PERFORMANCE_SYSTEM_INFO_GET \
    25                                   /* None                                                                     */
...
#define TX_TRACE_MUTEX_PERFORMANCE_INFO_GET \
    54 /* I1 = mutex ptr                                                           */
#define TX_TRACE_MUTEX_PERFORMANCE_SYSTEM_INFO_GET \
    55                               /* None                                                                     */
...
#define TX_TRACE_QUEUE_PERFORMANCE_INFO_GET \
    65 /* I1 = queue ptr                                                           */
#define TX_TRACE_QUEUE_PERFORMANCE_SYSTEM_INFO_GET \
    66                                /* None                                                                     */
...
#define TX_TRACE_SEMAPHORE_CEILING_PUT                                                                             \
    80                                 /* I1 = semaphore ptr, I2 = current count, I3 = suspended count,I4 =ceiling \
                                        */
...
#define TX_TRACE_SEMAPHORE_PERFORMANCE_INFO_GET \
    85 /* I1 = semaphore ptr                                                       */
#define TX_TRACE_SEMAPHORE__PERFORMANCE_SYSTEM_INFO_GET \
    86                                    /* None                                                                     */
...
#define TX_TRACE_THREAD_PERFORMANCE_SYSTEM_INFO_GET \
    106 /* None                                                                     */
#define TX_TRACE_THREAD_PREEMPTION_CHANGE \
    107 /* I1 = thread ptr, I2 = new threshold, I3 = old threshold, I4 =thread state*/
#define TX_TRACE_THREAD_PRIORITY_CHANGE \
    108                                /* I1 = thread ptr, I2 = new priority, I3 = old priority, I4 = thread state */
...
#define TX_TRACE_TIMER_PERFORMANCE_INFO_GET \
    128 /* I1 = timer ptr                                                           */
#define TX_TRACE_TIMER_PERFORMANCE_SYSTEM_INFO_GET \
    129 /* None                                                                     */
