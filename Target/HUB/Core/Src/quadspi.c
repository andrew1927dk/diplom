...
void HAL_QSPI_MspInit(QSPI_HandleTypeDef* qspiHandle)
{
  ...
  /* USER CODE END QUADSPI_MspInit 0 */
    ...
    PB6     ------> QUADSPI_BK1_NCS
    */
    GPIO_InitStruct.Pin = FLASH_IO3_Pin|FLASH_CLK_Pin;
    ...
    GPIO_InitStruct.Pin = FLASH_IO2_Pin|FLASH_IO0_Pin|FLASH_IO1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF9_QSPI;
...
void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef* qspiHandle)
{
  ...
  /* USER CODE END QUADSPI_MspDeInit 0 */
    ...
    PB6     ------> QUADSPI_BK1_NCS
    */
    HAL_GPIO_DeInit(GPIOD, FLASH_IO3_Pin|FLASH_CLK_Pin);

    HAL_GPIO_DeInit(GPIOC, FLASH_IO2_Pin|FLASH_IO0_Pin|FLASH_IO1_Pin);
